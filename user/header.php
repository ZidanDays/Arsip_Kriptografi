        ...
        <div class="profile-dtl">
          ...
          <?php while ($data = mysqli_fetch_array($query)) { ?>
            <h2><?php echo $data['fullname']; ?><p class="designation icon" style="color:green;">
                <strong><?php echo $data['job_title']; ?>
              </p></strong>
            </h2><?php } ?>
        </div>
      ...
      <div class="left-custom-menu-adp-wrap comment-scrollbar">
        <nav class="sidebar-nav left-sidebar-menu-pro">
          <ul class="metismenu" id="menu1">
            ...
            <li>
              <a class="nav-link" href="dekripsi.php" aria-expanded="false"><i class="fa-solid fa-unlock-keyhole"></i> <span class="mini-click-non">Dekripsi File</span></a>
            </li>
            <li>
            ...
            <li>
              <a class="nav-link" href="logout.php" aria-expanded="false"><i class="fa-solid fa-right-from-bracket"></i> <span class="mini-click-non">Logout</span></a>
            </li>
            <!-- ... (menu yang sudah ada) ... -->
          </ul>
        </nav>
