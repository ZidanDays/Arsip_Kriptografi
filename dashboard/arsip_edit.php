        ...
        <div class="col-lg-6 col-lg-offset-3">
            <div class="panel panel">
                ...
                <div class="panel-body">
                    ...
                    <?php 
                    $id = $_GET['id'];              
                    // $data = mysqli_query($connect, "select * from arsip, ruang where arsip_ruang=ruang_id and arsip_id='$id'");
                            ...
                            <select class="form-control" name="kategori" required="required">
                                ...
                                <?php 
                                    ...
                                    while($k = mysqli_fetch_array($kategori)){
                                        ?>
                                <option
                                    <?php if($k['kategori_id'] == $d['file_kategori']){echo "selected='selected'";} ?>
                        ...
                        <div>
                            ...
                            <div><label>Ruang</label>
                                ...
                                <select class="form-control" name="ruang" required="required">
                                    <option value="<?php echo $d['kode_ruang'];?>"><?php echo $d['kode_ruang'];?>
                                    </option>
                                    <?php 
                                $ruang = mysqli_query($connect,"SELECT * FROM ruang");
                                while($k = mysqli_fetch_array($ruang)){
                                    ?>
                                    <option value="<?php echo $k['ruang_id']; ?>"><?php echo $k['kode_ruang']; ?>
                                    </option>
                                    <?php 
                                }
                                ?>
