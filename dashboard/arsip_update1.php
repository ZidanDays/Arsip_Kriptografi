...
if($filename == ""){
	...
	mysqli_query($koneksi, "update arsip set arsip_kode='$kode', arsip_nama='$nama', arsip_kategori='$kategori', arsip_keterangan='$keterangan', arsip_ruang='$ruang', rak='$rak', box='$box', map='$map', urut='$urut' where arsip_id='$id'")or die(mysqli_error($koneksi));
